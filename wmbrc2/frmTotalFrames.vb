...
#End Region
    ...
    End Sub
    Public Sub MovieLengthCalc()

        Dim sngLengthMin As Object
        Dim sngLengthSec As Object
        Dim sngMovieFrames As Single

        If IsNumeric(My.Forms.frmWMbrC.cboHours.Text) = True AndAlso Len(My.Forms.frmWMbrC.cboHours.Text) > 0 _
        AndAlso IsNumeric(My.Forms.frmWMbrC.cboMins.Text) = True AndAlso Len(My.Forms.frmWMbrC.cboMins.Text) > 0 _
        AndAlso IsNumeric(My.Forms.frmWMbrC.cboSecs.Text) = True AndAlso Len(My.Forms.frmWMbrC.cboSecs.Text) > 0 Then
            sngLengthSec = My.Forms.frmWMbrC.cboHours.Text * 3600 + My.Forms.frmWMbrC.cboMins.Text * 60 + My.Forms.frmWMbrC.cboSecs.Text
            sngLengthMin = My.Forms.frmWMbrC.cboHours.Text * 60 + My.Forms.frmWMbrC.cboMins.Text + (My.Forms.frmWMbrC.cboSecs.Text) / 60
